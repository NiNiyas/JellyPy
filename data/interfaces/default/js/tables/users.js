...
users_list_table_options = {
    ...
    "columnDefs": [
        ...
        },
        {
            ...
            "createdCell": function (td, cellData, rowData, row, col) {
                var inactive = '';
                if (!rowData['is_active']) { inactive = '<span class="inactive-user-tooltip" data-toggle="tooltip" title="User not on Jellyfin server"><i class="fa fa-exclamation-triangle"></i></span>'; }
